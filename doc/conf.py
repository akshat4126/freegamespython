...
latex_documents = [
    (master_doc, 'FreeGamesPython.tex', 'Free Python Games Documentation',
     'Akshat', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'FreePythonGames', 'Free Python Games Documentation',
     'Akshat', 'FreePythonGames', 'Free Python Games for fun and learning.',
     'Miscellaneous'),
]
